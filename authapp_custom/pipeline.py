    ...
    if backend.name == "google-oauth2":
        if 'gender' in response.keys():
            if response['gender'] == 'male':
                user.shopuserprofile.gender = CustomUserProfile.MALE
            else:
                user.shopuserprofile.gender = CustomUserProfile.FEMALE
        ...
        if data.get('sex'):
            user.shopuserprofile.gender = \
                CustomUserProfile.MALE if data['sex'] == 2 else CustomUserProfile.FEMALE
